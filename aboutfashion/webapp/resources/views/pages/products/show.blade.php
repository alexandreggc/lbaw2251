    ...
    <body>
        <div class="row">
            <div class="col">
                <div id="carousel_product" class="carousel slide" data-bs-ride="true">
                    <div class="carousel-indicators">
                        <button type="button" data-bs-target="#carousel_product" data-bs-slide-to="0" class="active"
                            aria-current="true" aria-label="Slide 1"></button>
                        <button type="button" data-bs-target="#carousel_product" data-bs-slide-to="1"
                            aria-label="Slide 2"></button>
                        <button type="button" data-bs-target="#carousel_product" data-bs-slide-to="2"
                    ...
                    <div class="carousel-inner">
                            ...
                            <div class="row bg-body">
                                <div class="container-md">
                                    <img class="d-block w-100 img-fluid img-thumbnail"
                                        src="https://figueiraradical.com/4128-large_default/sweat-carhartt-hooded.jpg"
                                        alt="Los Angeles">
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <div class="row bg-body">
                                <div class="container-md">
                                    <img class="d-block w-100 img-fluid img-thumbnail"
                                        src="https://photos6.spartoo.pt/photos/209/20939896/20939896_500_A.jpg"
                                        alt="Chicago">
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <div class="row bg-body">
                                <div class="container-md">
                                    <img class="d-block w-100 img-fluid img-thumbnail"
                                        src="https://www.lolitamoda.pt/uploads/photo/image/97253/gallery_M128722_1.JPG"
                                        alt="New York">
                                </div>
                            </div>
                        </div>
