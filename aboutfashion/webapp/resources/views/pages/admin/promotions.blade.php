    ...
    <div class="container">
        ...
        <div class="row mb-5">
            <ul id="profile-tab" class="nav nav-tabs" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" data-bs-toggle="tab" href="/admin-panel/promotions" aria-selected="true" role="tab">
                        Promotions
                    </a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" data-bs-toggle="tab" href="/admin-panel/orders" aria-selected="true" role="tab">
                        Orders
                    </a>
                </li>
                <li class="nav-item" role="presentation">
