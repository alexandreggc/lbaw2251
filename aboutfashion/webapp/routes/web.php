...
Route::get('/products/{category}', 'PageController@showSearchPage')->name('searchProduct');
//Route::get('/products/{category}/{id}', 'App\Http\Controllers\ProductController@show');
