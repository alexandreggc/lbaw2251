    ...
    <div class="container-fluid mt-5 ">
        ...
        <div class="row mb-5">
            <div class="col-sm-3 col-md-3 col-lg-4 align-content-center justify-content-center mb-5">
                <div class="row mx-auto">
                    ...
                    <div class="card h-100 shadow costum-card text-center mx-auto">
                        <form class="mt-4 mb-4 " method="GET" action={{ route('productSearchAPI') }}>
                            <fieldset>
                                ...
                                <div class="card-group mt-4 ">
                                    ...
                                    <input type="range" class="form-range mx-auto" style="width:60%;display:block;"
                                        min="0" max="5" step="1" id="myRange" value="0">
            ...
            <div class="col-sm-9 col-md-9 col-lg-8 ">
                <div class="row mb-4">
                    <form method="GET">
                        <select class="form-select ms-auto" name="order"
                            style="background-color:#ecf0f1; width:15%; border: none; color:#212529; font-size: 18px;">
