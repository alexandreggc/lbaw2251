...
@section('content')
    ...
    <body style="justify-content-center">
        ...
        <div id="carouselExampleControls" class="carousel slide carousel-dark text-center mx-3 mb-5" data-bs-ride="carousel">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            src="https://digimedia.web.ua.pt/wp-content/uploads/2017/05/default-user-image.png" alt="avatar"
                            style="width: 150px;" />
